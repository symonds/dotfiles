...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_all( \
        ...
        KC_LCTL, KC_LGUI, KC_LALT,           KC_NO,            KC_SPC,           KC_NO,            KC_RALT, KC_RGUI, MO(1),   KC_LEFT, KC_DOWN, KC_RGHT  \
    ),
    /* Layer 1: Function layer */
    [1] = LAYOUT_all( \
        KC_GRV,  KC_F1,   KC_F2,   KC_F3,    KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______,  KC_DEL, KC_SLCK, \
        _______, _______, BL_TOGG, RGB_TOG,  _______, _______, _______, RGB_HUI, RGB_HUD, _______, _______, KC_VOLD, KC_VOLU, _______,          _______, \
